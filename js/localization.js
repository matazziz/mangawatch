    ...
    constructor() {
        ...
        this.translations = {
            fr: {
                ...
                'salon.members': 'Membres',
                'salon.channels': 'Salons',
                'salon.online': 'En ligne',
                'salon.offline': 'Hors ligne',
                'salon.empty': 'Aucun message pour l\'instant. Lancez la conversation !',
                'salon.no_members': 'Aucun membre trouvé',
                'salon.login_link': 'Connectez-vous',
                'salon.login_suffix': ' pour participer au forum.',
                'salon.placeholder': 'Envoyer un message…',
                'salon.search_members': 'Rechercher…',
                'salon.auth_required': 'Reconnectez-vous pour envoyer un message.',
                'salon.send_error': 'Impossible d\'envoyer le message.',

                'salon.create_title': 'Créer un salon',
                'salon.create_name': 'Nom du salon',
                'salon.create_name_ph': 'Ex : One Piece, Recos manga…',
                'salon.create_desc': 'Description (optionnel)',
                'salon.create_desc_ph': 'De quoi parle ce salon ?',
                'salon.create_message': 'Premier message (obligatoire)',
                'salon.create_message_ph': 'Présentez le salon ou lancez la discussion…',
                'salon.create_hint': 'Votre salon apparaîtra dans la barre latérale une fois créé.',
                'salon.create_cancel': 'Annuler',
                'salon.create_submit': 'Créer le salon',
                'salon.create_name_short': 'Le nom doit contenir au moins 2 caractères.',
                'salon.create_message_required': 'Écrivez un premier message pour créer le salon.',
                'salon.create_error': 'Impossible de créer le salon.',
                'salon.created_by': 'Créé par',
                'salon.channel_default_desc': 'Salon de discussion',
                'salon.placeholder_in': 'Envoyer un message dans',
                'salon.mention_hint': 'Astuce : tapez @ pour mentionner un membre',
                'salon.edit': 'Modifier',
                'salon.edit_title': 'Modifier le message',
                'salon.edit_save': 'Enregistrer',
                'salon.delete': 'Supprimer',
                'salon.delete_title': 'Supprimer le message',
                'salon.delete_warning': 'Cette action est irréversible.',
                'salon.edited': 'modifié',
                'salon.edit_prompt': 'Votre message',
                'salon.edit_empty': 'Le message ne peut pas être vide.',
                'salon.edit_error': 'Impossible de modifier le message.',
                'salon.delete_confirm': 'Supprimer ce message ?',
                'salon.delete_error': 'Impossible de supprimer le message.',
                'salon.delete_channel_confirm': 'Supprimer définitivement ce salon et tous ses messages ?',
                'salon.delete_channel_error': 'Impossible de supprimer le salon.',

                'salon.poll_btn': 'Créer un sondage',
                'salon.poll_title': 'Créer un sondage',
                'salon.poll_question': 'Question',
                'salon.poll_question_ph': 'Ex : Quel est votre anime préféré ?',
                'salon.poll_options': 'Options de réponse',
                'salon.poll_option_ph': 'Option',
                'salon.poll_add_option': 'Ajouter une option',
                'salon.poll_remove_option': 'Retirer cette option',
                'salon.poll_submit': 'Publier le sondage',
                'salon.poll_label': 'Sondage',
                'salon.poll_votes_one': '1 vote',
                'salon.poll_votes': '{n} votes',
                'salon.poll_error': 'Impossible de créer le sondage.',
                'salon.poll_vote_error': 'Impossible d\'enregistrer votre vote.',
                'salon.poll_min_options': 'Ajoutez au moins 2 options.',
                'salon.poll_duration': 'Durée du sondage',
                'salon.poll_duration_1h': '1 heure',
                'salon.poll_duration_6h': '6 heures',
                'salon.poll_duration_24h': '24 heures',
                'salon.poll_duration_3d': '3 jours',
                'salon.poll_duration_7d': '7 jours',
                'salon.poll_duration_unlimited': 'Sans limite',
                'salon.poll_ends_in': 'Se termine dans {time}',
                'salon.poll_closed': 'Sondage terminé',
                'salon.poll_ended_error': 'Ce sondage est terminé.',
                
                // Titres de pages essentiels
                'catalogue.title.manga': 'Mangas',
                'catalogue.title.anime': 'Animes',
                'catalogue.api_error.title': 'Impossible de charger les résultats',
                'catalogue.api_error.lead': 'Nous n\'avons pas pu afficher les mangas et animes pour le moment.',
                'catalogue.api_error.step_filters': 'Réinitialisez les filtres ou rafraîchissez la page.',
                'catalogue.api_error.step_api': 'Si le problème persiste, le catalogue est temporairement indisponible de notre côté. Notre équipe travaille déjà à rétablir le service.',
                'catalogue.api_error.thanks': 'Merci pour votre patience et toutes nos excuses pour la gêne occasionnée.',
                'catalogue.api_error.reset_filters': 'Réinitialiser les filtres',
                'catalogue.api_error.refresh': 'Rafraîchir la page',
                ...
                // Sondage nouveautés site
                'home.feature_poll_title': 'Quelle nouveauté pour MangaWatch ?',
                'home.feature_poll_intro': 'Votez comme sur Reddit : une flèche haut ou bas par idée. Recliquez sur votre vote pour l\'annuler. Le podium affiche le top 3 qui sera développé en priorité.',
                'home.feature_poll_login': 'Connectez-vous pour voter.',
                'home.feature_poll_podium_label': 'Top 3 — prochaines fonctionnalités à développer',
                'home.feature_poll_ranking': 'Classement complet',
                'home.feature_poll_up': 'Monter',
                'home.feature_poll_down': 'Descendre',
                'home.feature_poll_points': 'pts',
                'home.feature_poll_place_1': '1er',
                'home.feature_poll_place_2': '2e',
                'home.feature_poll_place_3': '3e',
                'home.feature_poll_search_placeholder': 'Rechercher une idée, un pseudo ou un thème…',
                'home.feature_poll_theme_all': 'Tous les thèmes',
                'home.feature_poll_add_btn': 'Proposer une idée',
                'home.feature_poll_add_title': 'Nouvelle proposition',
                'home.feature_poll_add_name': 'Titre de l\'idée',
                'home.feature_poll_add_desc': 'Description',
                'home.feature_poll_add_theme': 'Thème',
                'home.feature_poll_add_submit': 'Publier',
                'home.feature_poll_add_success': 'Votre idée a été publiée !',
                'home.feature_poll_add_login': 'Connectez-vous pour proposer une idée.',
                'home.feature_poll_no_results': 'Aucune proposition ne correspond à votre recherche.',
                'home.feature_poll_page_prev': 'Précédent',
                'home.feature_poll_page_next': 'Suivant',
                'home.feature_poll_delete': 'Supprimer cette idée',
                'home.feature_poll_delete_confirm': 'Supprimer « {title} » pour tous les utilisateurs ?',
                'home.feature_poll_delete_success': 'Idée supprimée.',
                'home.feature_poll_delete_error': 'Impossible de supprimer cette idée.',
                'home.feature_poll_page_info': 'Page {page} / {total}',
                'home.feature_poll_author_official': 'MangaWatch',
                'home.feature_poll_theme_social': 'Social',
                'home.feature_poll_theme_collection': 'Collection',
                'home.feature_poll_theme_ui': 'Interface',
                'home.feature_poll_theme_community': 'Communauté',
                'home.feature_poll_theme_notifications': 'Alertes',
                'home.feature_poll_theme_tech': 'Technique',
                'home.feature_poll_vote_btn': 'Voter',
                'home.feature_poll_voted': 'Voté',
                'home.feature_poll_already': 'Vous avez déjà voté sur cette proposition.',
                'home.feature_poll_success': 'Vote enregistré.',
                'home.feature_poll_total': '{count} interaction(s) au total',
                'home.feature_poll_votes_label': 'votes',
                'home.feature_poll_opt_recommendations': 'Recommandations personnalisées',
                'home.feature_poll_opt_recommendations_desc': 'Suggestions d\'animes et mangas selon vos goûts et votre historique.',
                'home.feature_poll_opt_calendar': 'Calendrier des sorties',
                'home.feature_poll_opt_calendar_desc': 'Planning hebdomadaire des nouveaux épisodes et chapitres.',
                'home.feature_poll_opt_social': 'Fil d\'activité & amis',
                'home.feature_poll_opt_social_desc': 'Suivre ce que regardent vos amis et partager vos avis.',
                'home.feature_poll_opt_tierlist': 'Tier lists partagées',
                'home.feature_poll_opt_tierlist_desc': 'Créer et comparer des classements visuels avec la communauté.',
                'home.feature_poll_opt_compare': 'Comparateur d\'œuvres',
                'home.feature_poll_opt_compare_desc': 'Comparer deux animes ou mangas côte à côte (notes, genres, synopsis).',
                'home.feature_poll_opt_notifications': 'Alertes nouveaux épisodes',
                'home.feature_poll_opt_notifications_desc': 'Notifications quand sort un épisode ou chapitre de votre liste.',
                'home.feature_poll_opt_offline': 'Mode hors-ligne (PWA)',
                'home.feature_poll_opt_offline_desc': 'Consulter votre collection et vos notes sans connexion.',

                'home.personalized_recs_title': 'Recommandations personnalisées',
                'home.personalized_recs_intro': 'Répondez à quelques questions pour découvrir des animes et mangas faits pour vous.',
                'home.personalized_recs_type_anime': 'Anime',
                'home.personalized_recs_type_manga': 'Manga',
                'home.rec_quiz_step': 'Question {current} / {total}',
                'home.rec_quiz_prev': 'Précédent',
                'home.rec_quiz_next': 'Suivant',
                'home.rec_quiz_submit': 'Voir mes recommandations',
                'home.rec_quiz_restart': 'Refaire le questionnaire',
                'home.rec_quiz_computing': 'Sélection de vos animes et mangas…',
                'home.rec_quiz_results_daily': 'Vos 2 animes du jour (renouvelés chaque jour) :',
                'home.rec_quiz_results_manga': 'Vos 2 mangas du jour (renouvelés chaque jour) :',
                'home.rec_quiz_results_both': 'Votre anime et votre manga du jour (renouvelés chaque jour) :',
                'home.rec_quiz_match_because': 'Choisi pour : {profile}',
                'home.rec_quiz_view': 'Voir la fiche',
                'home.rec_quiz_match_default': 'Correspond à votre profil',
                'home.rec_quiz_no_match': 'Aucun titre ne correspond exactement à cette combinaison. Essayez des genres un peu plus larges.',
                'home.rec_quiz_multi_hint': 'Choisissez jusqu\'à {max} options.',
                'home.rec_quiz_q_media': 'Quel format vous intéresse ?',
                'home.rec_quiz_q_media_hint': 'Anime, manga ou les deux.',
                'home.rec_quiz_opt_anime': 'Anime',
                'home.rec_quiz_opt_manga': 'Manga',
                'home.rec_quiz_opt_both': 'Les deux',
                'home.rec_quiz_q_genres': 'Quel genre vous attire ?',
                'home.rec_quiz_q_genres_hint': 'Choisissez un seul genre principal.',
                'home.rec_quiz_genre_action': 'Action / Aventure',
                'home.rec_quiz_genre_romance': 'Romance',
                'home.rec_quiz_genre_fantasy': 'Fantasy',
                'home.rec_quiz_genre_horror': 'Horreur / Thriller',
                'home.rec_quiz_genre_comedy': 'Comédie',
                'home.rec_quiz_genre_slice': 'Slice of life',
                'home.rec_quiz_genre_scifi': 'Sci-Fi',
                'home.rec_quiz_genre_sports': 'Sports',
                'home.rec_quiz_genre_drama': 'Drame',
                'home.rec_quiz_genre_mystery': 'Mystère / Enquête',
                'home.rec_quiz_genre_supernatural': 'Surnaturel',
                'home.rec_quiz_genre_psychological': 'Psychologique',
                'home.rec_quiz_genre_mecha': 'Mecha',
                'home.rec_quiz_genre_music': 'Musique / Arts',
                'home.rec_quiz_genre_isekai': 'Isekai / Réincarnation',
                'home.rec_quiz_genre_school': 'School life / Lycée',
                'home.rec_quiz_genre_historical': 'Historique',
                'home.rec_quiz_genre_martial_arts': 'Arts martiaux',
                'home.rec_quiz_genre_military': 'Militaire / Guerre',
                'home.rec_quiz_genre_adventure': 'Aventure',
                'home.rec_quiz_q_mood': 'Quelle ambiance recherchez-vous ?',
                'home.rec_quiz_q_mood_hint': 'Le ton général que vous voulez ressentir.',
                'home.rec_quiz_mood_intense': 'Intense & épique',
                'home.rec_quiz_mood_emotional': 'Émotionnel & touchant',
                'home.rec_quiz_mood_feelgood': 'Léger & feel-good',
                'home.rec_quiz_mood_dark': 'Sombre & mystérieux',
                'home.rec_quiz_mood_relaxing': 'Calme & apaisant',
                'home.rec_quiz_mood_humorous': 'Drôle & décalé',
                'home.rec_quiz_mood_thrilling': 'Suspense & frissons',
                'home.rec_quiz_mood_epic': 'Épique & grandiose',
                'home.rec_quiz_mood_tender': 'Tendre & romantique',
                'home.rec_quiz_mood_inspirational': 'Inspirant & motivant',
                'home.rec_quiz_mood_melancholic': 'Mélancolique & poétique',
                'home.rec_quiz_mood_chaotic': 'Délirant & imprévisible',
                'home.rec_quiz_mood_nostalgic': 'Nostalgique & cosy',
                'home.rec_quiz_q_length': 'Quelle durée préférez-vous ?',
                'home.rec_quiz_q_length_hint': 'Court, moyen ou long format.',
                'home.rec_quiz_len_short': 'Court (film / mini-série)',
                'home.rec_quiz_len_medium': 'Série moyenne',
                'home.rec_quiz_len_long': 'Longue saga',
                'home.rec_quiz_q_focus': 'Qu\'est-ce qui compte le plus pour vous ?',
                'home.rec_quiz_q_focus_hint': 'L\'élément principal qui vous accroche.',
                'home.rec_quiz_focus_fights': 'Combats & action',
                'home.rec_quiz_focus_plot': 'Intrigue & suspense',
                'home.rec_quiz_focus_characters': 'Personnages & relations',
                'home.rec_quiz_focus_world': 'Univers & worldbuilding',
                'home.rec_quiz_focus_humor': 'Humour & gags',
                'home.rec_quiz_focus_art': 'Animation & direction artistique',
                'home.rec_quiz_focus_music': 'Musique & bande-son',
                'home.rec_quiz_focus_twists': 'Rebondissements & surprises',
                'home.rec_quiz_focus_strategy': 'Stratégie & réflexion',
                'home.rec_quiz_focus_dialogue': 'Dialogues & écriture',
                'home.rec_quiz_focus_atmosphere': 'Atmosphère immersive',
                'home.rec_quiz_focus_chemistry': 'Chimie & dynamique',
                ...
                'profile.rating.your_rating': 'Votre note :',
                'profile.rating.rate': 'Noter',
                'profile.rating.rated': 'Noté',
                'profile.rating.rated_n': 'Noté {n}/10',
                'profile.rating.modal_title': 'Noter ce profil',
                'profile.rating.modal_subtitle': 'Choisissez une note de 1 à 10',
                'profile.rating.modal_edit_title': 'Modifier votre note',
                'profile.rating.modal_edit_subtitle': 'Choisissez une nouvelle note de 1 à 10',
                'profile.rating.change_rating': 'Modifier votre note ({n}/10)',
                'profile.rating.one_vote': '1 note',
                'profile.rating.votes': '{n} notes',
                'profile.rating.rate_n': 'Noter {n}/10',
                'profile.rating.error': 'Impossible d\'enregistrer votre note.',
                ...
                'auth.media_setup_title': 'Personnalisez votre profil',
                'auth.media_setup_subtitle': 'Choisissez votre photo de profil et votre bannière pour commencer.',
                'auth.media_setup_subtitle_named': 'Bienvenue {name} ! Choisissez votre photo et votre bannière.',
                'auth.media_setup_avatar': 'Photo de profil',
                'auth.media_setup_banner': 'Bannière',
                'auth.media_setup_pick_avatar': 'Choisir une photo',
                'auth.media_setup_pick_banner': 'Choisir une bannière',
                'auth.media_setup_finish': 'Terminer',
                'auth.media_setup_skip': 'Passer pour l\'instant',
                'auth.media_setup_uploading': 'Enregistrement en cours…',
                'auth.media_setup_done': 'Profil mis à jour !',
                'auth.media_setup_error': 'Erreur lors de l\'enregistrement. Réessayez ou passez cette étape.',
                'onboarding.default_name': 'nouveau membre',
                'onboarding.welcome_title': 'Bienvenue sur MangaWatch !',
                'onboarding.welcome_body': 'Bonjour {name} ! Votre compte est prêt. Suivez ce court guide pour configurer votre profil comme un pro.',
                'onboarding.welcome_tip1': 'Nous allons voir comment noter, créer votre Top 10 et remplir votre collection.',
                'onboarding.rate_title': 'Étape 1 — Donner une note',
                'onboarding.rate_body': 'Avant le Top 10, il faut noter des œuvres. Rendez-vous dans la section Manga et Anime, ouvrez une fiche détail et attribuez une note avec les étoiles.',
                'onboarding.rate_tip1': 'Cliquez sur « Manga et Anime » dans le menu du site',
                'onboarding.rate_tip2': 'Choisissez un anime ou un manga pour ouvrir sa page détail',
                'onboarding.rate_tip3': 'Sur la fiche, cliquez sur les étoiles pour noter l\'œuvre',
                'onboarding.rate_link': 'Explorer Manga et Anime',
                'onboarding.top10_title': 'Étape 2 — Créer votre Top 10',
                'onboarding.top10_body': 'Une fois des œuvres notées, allez sur votre profil : l\'onglet « Manga et Anime » affiche vos notes. Vous pourrez alors les placer dans votre Top 10.',
                'onboarding.top10_tip1': 'Ouvrez « Profil » puis l\'onglet « Manga et Anime »',
                'onboarding.top10_tip2': 'Sur une carte déjà notée : menu « … » → « Ajouter au top 10 »',
                'onboarding.top10_tip3': 'Choisissez la place (1 à 10) dans votre classement',
                'onboarding.top10_link': 'Aller sur mon profil',
                'onboarding.collection_title': 'Étape 3 — Votre collection',
                'onboarding.collection_body': 'Ajoutez des œuvres à votre collection depuis une page détail pour suivre votre progression : en cours, terminé, en pause, à voir…',
                'onboarding.collection_tip1': 'Sur une fiche anime/manga : bouton « Ajouter à ma collection »',
                'onboarding.collection_tip2': 'Choisissez un statut (En cours, Terminé, etc.)',
                'onboarding.collection_tip3': 'Retrouvez tout dans « Ma collection »',
                'onboarding.collection_link': 'Voir ma collection',
                ...
                'profile.settings.no_password': 'Aucun mot de passe requis',
                        ...
                        'synopsis': 'Synopsis',
                        'details.franchise_anime': 'Franchise anime',
                        'details.franchise_manga': 'Franchise manga',
                        'details.franchise_manhwa': 'Franchise manhwa',
                        'details.franchise_manhua': 'Franchise manhua',
                        'details.franchise_novel': 'Franchise roman',
                        'details.franchise_doujin': 'Franchise doujin',
                        'details.franchise_films': 'Franchise cinéma',
                        'details.other_seasons': 'Autres saisons',
                        'details.other_volumes': 'Autres volumes',
                        'details.other_volumes_manhwa': 'Autres volumes',
                        'details.other_volumes_manhua': 'Autres volumes',
                        'details.other_volumes_novel': 'Autres tomes',
                        'details.other_volumes_doujin': 'Autres doujins',
                        'details.other_films': 'Autres films',
                        'genres': 'Genres',
            ...
            en: {
                ...
                'catalogue.api_error.title': 'Unable to load results',
                'catalogue.api_error.lead': 'We couldn\'t display manga and anime right now.',
                'catalogue.api_error.step_filters': 'Reset your filters or refresh the page.',
                'catalogue.api_error.step_api': 'If it still doesn\'t work, the catalogue is temporarily unavailable on our side. Our team is already working to restore the service.',
                'catalogue.api_error.thanks': 'Thank you for your patience, and sorry for the inconvenience.',
                'catalogue.api_error.reset_filters': 'Reset filters',
                'catalogue.api_error.refresh': 'Refresh page',
                ...
                'synopsis': 'Synopsis',
                'details.franchise_anime': 'Anime franchise',
                'details.franchise_manga': 'Manga franchise',
                'details.franchise_manhwa': 'Manhwa franchise',
                'details.franchise_manhua': 'Manhua franchise',
                'details.franchise_novel': 'Novel franchise',
                'details.franchise_doujin': 'Doujin franchise',
                'details.franchise_films': 'Film franchise',
                'details.other_seasons': 'Other seasons',
                'details.other_volumes': 'Other volumes',
                'details.other_volumes_manhwa': 'Other volumes',
                'details.other_volumes_manhua': 'Other volumes',
                'details.other_volumes_novel': 'Other volumes',
                'details.other_volumes_doujin': 'Other doujins',
                'details.other_films': 'Other films',
                'genres': 'Genres',
                ...
                // Site feature poll
                'home.feature_poll_title': 'What should we build next on MangaWatch?',
                'home.feature_poll_intro': 'Vote Reddit-style: one up or down per idea (not both). The podium shows the top 3 features we will build first.',
                'home.feature_poll_login': 'Sign in to vote.',
                'home.feature_poll_podium_label': 'Top 3 — next features to build',
                'home.feature_poll_ranking': 'Full ranking',
                'home.feature_poll_up': 'Upvote',
                'home.feature_poll_down': 'Downvote',
                'home.feature_poll_points': 'pts',
                'home.feature_poll_place_1': '1st',
                'home.feature_poll_place_2': '2nd',
                'home.feature_poll_place_3': '3rd',
                'home.feature_poll_search_placeholder': 'Search idea, username or theme…',
                'home.feature_poll_theme_all': 'All themes',
                'home.feature_poll_add_btn': 'Suggest an idea',
                'home.feature_poll_add_title': 'New suggestion',
                'home.feature_poll_add_name': 'Idea title',
                'home.feature_poll_add_desc': 'Description',
                'home.feature_poll_add_theme': 'Theme',
                'home.feature_poll_add_submit': 'Publish',
                'home.feature_poll_add_success': 'Your idea has been published!',
                'home.feature_poll_add_login': 'Sign in to suggest an idea.',
                'home.feature_poll_no_results': 'No suggestions match your search.',
                'home.feature_poll_page_prev': 'Previous',
                'home.feature_poll_page_next': 'Next',
                'home.feature_poll_delete': 'Delete this idea',
                'home.feature_poll_delete_confirm': 'Delete « {title} » for all users?',
                'home.feature_poll_delete_success': 'Idea deleted.',
                'home.feature_poll_delete_error': 'Unable to delete this idea.',
                'home.feature_poll_page_info': 'Page {page} / {total}',
                'home.feature_poll_author_official': 'MangaWatch',
                'home.feature_poll_theme_social': 'Social',
                'home.feature_poll_theme_collection': 'Collection',
                'home.feature_poll_theme_ui': 'Interface',
                'home.feature_poll_theme_community': 'Community',
                'home.feature_poll_theme_notifications': 'Alerts',
                'home.feature_poll_theme_tech': 'Technical',
                'home.feature_poll_vote_btn': 'Vote',
                'home.feature_poll_voted': 'Voted',
                'home.feature_poll_already': 'You have already voted on this option.',
                'home.feature_poll_success': 'Vote saved.',
                'home.feature_poll_total': '{count} interaction(s) total',
                'home.feature_poll_votes_label': 'votes',
                'home.feature_poll_opt_recommendations': 'Personalized recommendations',
                'home.feature_poll_opt_recommendations_desc': 'Anime and manga suggestions based on your tastes and history.',
                'home.feature_poll_opt_calendar': 'Release calendar',
                'home.feature_poll_opt_calendar_desc': 'Weekly schedule of new episodes and chapters.',
                'home.feature_poll_opt_social': 'Activity feed & friends',
                'home.feature_poll_opt_social_desc': 'See what friends are watching and share your reviews.',
                'home.feature_poll_opt_tierlist': 'Shared tier lists',
                'home.feature_poll_opt_tierlist_desc': 'Create and compare visual rankings with the community.',
                'home.feature_poll_opt_compare': 'Title comparator',
                'home.feature_poll_opt_compare_desc': 'Compare two anime or manga side by side (ratings, genres, synopsis).',
                'home.feature_poll_opt_notifications': 'New episode alerts',
                'home.feature_poll_opt_notifications_desc': 'Get notified when an episode or chapter from your list is released.',
                'home.feature_poll_opt_offline': 'Offline mode (PWA)',
                'home.feature_poll_opt_offline_desc': 'Browse your collection and ratings without a connection.',

                'home.personalized_recs_title': 'Personalized recommendations',
                'home.personalized_recs_intro': 'Answer a few questions to discover anime and manga picked for you.',
                'home.personalized_recs_type_anime': 'Anime',
                'home.personalized_recs_type_manga': 'Manga',
                'home.rec_quiz_step': 'Question {current} / {total}',
                'home.rec_quiz_prev': 'Previous',
                'home.rec_quiz_next': 'Next',
                'home.rec_quiz_submit': 'See my recommendations',
                'home.rec_quiz_restart': 'Retake the quiz',
                'home.rec_quiz_computing': 'Picking your anime and manga…',
                'home.rec_quiz_results_daily': 'Your 2 anime picks of the day (refreshed daily):',
                'home.rec_quiz_results_manga': 'Your 2 manga picks of the day (refreshed daily):',
                'home.rec_quiz_results_both': 'Your anime and manga of the day (refreshed daily):',
                'home.rec_quiz_match_because': 'Picked for: {profile}',
                'home.rec_quiz_view': 'View details',
                'home.rec_quiz_match_default': 'Matches your profile',
                'home.rec_quiz_no_match': 'No title matches this exact combination. Try slightly broader genres.',
                'home.rec_quiz_multi_hint': 'Choose up to {max} options.',
                'home.rec_quiz_q_media': 'Which format interests you?',
                'home.rec_quiz_q_media_hint': 'Anime, manga, or both.',
                'home.rec_quiz_opt_anime': 'Anime',
                'home.rec_quiz_opt_manga': 'Manga',
                'home.rec_quiz_opt_both': 'Both',
                'home.rec_quiz_q_genres': 'Which genre appeals to you?',
                'home.rec_quiz_q_genres_hint': 'Pick one main genre.',
                'home.rec_quiz_genre_action': 'Action / Adventure',
                'home.rec_quiz_genre_romance': 'Romance',
                'home.rec_quiz_genre_fantasy': 'Fantasy',
                'home.rec_quiz_genre_horror': 'Horror / Thriller',
                'home.rec_quiz_genre_comedy': 'Comedy',
                'home.rec_quiz_genre_slice': 'Slice of life',
                'home.rec_quiz_genre_scifi': 'Sci-Fi',
                'home.rec_quiz_genre_sports': 'Sports',
                'home.rec_quiz_genre_drama': 'Drama',
                'home.rec_quiz_genre_mystery': 'Mystery / Investigation',
                'home.rec_quiz_genre_supernatural': 'Supernatural',
                'home.rec_quiz_genre_psychological': 'Psychological',
                'home.rec_quiz_genre_mecha': 'Mecha',
                'home.rec_quiz_genre_music': 'Music / Arts',
                'home.rec_quiz_genre_isekai': 'Isekai / Reincarnation',
                'home.rec_quiz_genre_school': 'School life',
                'home.rec_quiz_genre_historical': 'Historical',
                'home.rec_quiz_genre_martial_arts': 'Martial arts',
                'home.rec_quiz_genre_military': 'Military / War',
                'home.rec_quiz_genre_adventure': 'Adventure',
                'home.rec_quiz_q_mood': 'What mood are you looking for?',
                'home.rec_quiz_q_mood_hint': 'The overall tone you want to feel.',
                'home.rec_quiz_mood_intense': 'Intense & epic',
                'home.rec_quiz_mood_emotional': 'Emotional & touching',
                'home.rec_quiz_mood_feelgood': 'Light & feel-good',
                'home.rec_quiz_mood_dark': 'Dark & mysterious',
                'home.rec_quiz_mood_relaxing': 'Calm & relaxing',
                'home.rec_quiz_mood_humorous': 'Funny & offbeat',
                'home.rec_quiz_mood_thrilling': 'Suspense & thrills',
                'home.rec_quiz_mood_epic': 'Epic & grand',
                'home.rec_quiz_mood_tender': 'Tender & romantic',
                'home.rec_quiz_mood_inspirational': 'Inspiring & uplifting',
                'home.rec_quiz_mood_melancholic': 'Melancholic & poetic',
                'home.rec_quiz_mood_chaotic': 'Wild & unpredictable',
                'home.rec_quiz_mood_nostalgic': 'Nostalgic & cozy',
                'home.rec_quiz_q_length': 'What length do you prefer?',
                'home.rec_quiz_q_length_hint': 'Short, medium, or long format.',
                'home.rec_quiz_len_short': 'Short (movie / mini-series)',
                'home.rec_quiz_len_medium': 'Medium series',
                'home.rec_quiz_len_long': 'Long saga',
                'home.rec_quiz_q_focus': 'What matters most to you?',
                'home.rec_quiz_q_focus_hint': 'The main hook that keeps you watching.',
                'home.rec_quiz_focus_fights': 'Fights & action',
                'home.rec_quiz_focus_plot': 'Plot & suspense',
                'home.rec_quiz_focus_characters': 'Characters & relationships',
                'home.rec_quiz_focus_world': 'World & lore',
                'home.rec_quiz_focus_humor': 'Humor & gags',
                'home.rec_quiz_focus_art': 'Animation & art direction',
                'home.rec_quiz_focus_music': 'Music & soundtrack',
                'home.rec_quiz_focus_twists': 'Twists & surprises',
                'home.rec_quiz_focus_strategy': 'Strategy & mind games',
                'home.rec_quiz_focus_dialogue': 'Dialogue & writing',
                'home.rec_quiz_focus_atmosphere': 'Immersive atmosphere',
                'home.rec_quiz_focus_chemistry': 'Chemistry & dynamics',
                ...
                'profile.rating.your_rating': 'Your rating:',
                'profile.rating.rate': 'Rate',
                'profile.rating.rated': 'Rated',
                'profile.rating.rated_n': 'Rated {n}/10',
                'profile.rating.modal_title': 'Rate this profile',
                'profile.rating.modal_subtitle': 'Choose a score from 1 to 10',
                'profile.rating.modal_edit_title': 'Change your rating',
                'profile.rating.modal_edit_subtitle': 'Choose a new score from 1 to 10',
                'profile.rating.change_rating': 'Change your rating ({n}/10)',
                'profile.rating.one_vote': '1 rating',
                'profile.rating.votes': '{n} ratings',
                'profile.rating.rate_n': 'Rate {n}/10',
                'profile.rating.error': 'Unable to save your rating.',
...
async function translateSynopses(targetLanguage) {
    const synopsisElements = document.querySelectorAll('.synopsis-text, .content-synopsis, .anime-synopsis, .manga-synopsis, .profile-card-synopsis, .rec-premium-synopsis');
...
async function translateEntireSiteAutomatically() {
    ...
    try {
        ...
        const synopsisElements = document.querySelectorAll('.manga-info .manga-synopsis, .manga-info .content-synopsis, .profile-card-synopsis, .content-synopsis, .rec-premium-synopsis');
        const genreElements = document.querySelectorAll('.genre-tag, .type-badge');
...
async function translateVisibleContent() {
    ...
    const visibleSynopses = document.querySelectorAll('.synopsis-text, .content-synopsis, .anime-synopsis, .manga-synopsis, .rec-premium-synopsis');
